...
class MemberRepositoryTest {
    ...
    void getAllMembers(){
        ...
        // memberRepository 는 상속받는 메서드명을 그대로 가져가니까
    ...
    @Test
    void saveMembers(){
        // given - 다수의 객체를 저장할 예정이므로 collections 를 사용할 겁니다. -> List
    ...
    void deleteMemberById(){
        // when
        memberRepository.deleteById(2L);    // 여기서 이미 삭제 완료

        // then                             // 2L 에 해당하는 객체를 찾았을 때 empty 인지 확인
