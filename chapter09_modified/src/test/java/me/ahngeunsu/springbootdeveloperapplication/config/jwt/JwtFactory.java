package me.ahngeunsu.springbootdeveloperapplication.config.jwt;
...
/*
    빌더 패턴을 사용해 객체를 만들 때 테스트가 필요한 데이터만 사용
    빌터패턴을 사용하지 않을 필드 기본값을 사용하게 됩니다.

        test/java/me.../config/jwt 에 TokenProviderTest.java 파일을 만들겁니다.
 */