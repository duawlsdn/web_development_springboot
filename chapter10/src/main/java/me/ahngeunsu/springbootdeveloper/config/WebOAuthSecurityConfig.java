...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                // 3. 토큰 재발급 URL 은 인증 없이 접근 가능하도록 설정. 나머지 API URL은 인증 필요
                ...
                // 6. /api 로 시작하는 url 인 경우 401 상태 코드를 반환 하도록 예외 처리
    ...
    // 바로 다음에 작성할 파일이므로 빨간줄(오류) 떠도 됩니다.
    @Bean
...
/*
    ...
    config / oauth / OAuth2AuthorizationRequestBasedOnCookieRepository 클래스 생성
 */
